...
class Generator(nn.Module, Track):
    ...
    def get_weight(self, mask_c, mask_s, fea_c, fea_s, diff_c, diff_s):
        ...
        with torch.no_grad():
            # v = weight.detach().nonzero().long().permute(1, 0) # original code
            
            v = torch.nonzero(weight.detach(), as_tuple=False).long().permute(1, 0)
    ...
    def forward(self, c, s, mask_c, mask_s, diff_c, diff_s, gamma=None, beta=None, ret=False):
        ...
        save_path_mask_s_lips = 'save_path_mask_s_lips.png'

        save_path_mask_c_skin = 'save_path_mask_c_skin.png'
        save_path_mask_s_skin = 'save_path_mask_s_skin.png'
